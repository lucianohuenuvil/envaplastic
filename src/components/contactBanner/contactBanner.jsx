...
export function ContactBanner(){
    return (
        <div className="mt-16 relative min-h-[300px] md:min-h-[400px]">
          <img src="/images/contact-image.webp" alt="Banner" className="absolute inset-0 w-full h-full object-cover" />
          ...
          <div className="absolute inset-0 flex items-center justify-center text-center text-white">
            <div className="relative z-10 p-6">
              ...
              <Link href="#formularioContacto" className="inline-block px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow-lg hover:bg-blue-700 transition-colors">
                  Envíanos un mensaje
              </Link>
            </div>
          </div>
