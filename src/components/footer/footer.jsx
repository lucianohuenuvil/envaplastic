            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 md:grid-cols-3 pt-2">
                        ...
                        <div>
                            <h2 className="mb-2 md:mb-6 text-sm font-semibold uppercase text-black">NUESTRAS REDES</h2>
                            <ul className="text-gray-500  font-medium">
                                {/* <li className="mb-4">
                                    <Link href="/" className="hover:underline ">Instagram</Link>
                                </li> */}
                                <li>
                                    <Link target="_blank" href="https://www.facebook.com/profile.php?id=61565350462822&mibextid=ZbWKwL" className="hover:underline">Facebook</Link>
                                </li>
                            </ul>
                        </div>
                        <div>
                            <h2 className="mb-2 md:mb-6 text-sm font-semibold uppercase text-black">Legal</h2>
                            <ul className="text-gray-500  font-medium">
                                {/* <li className="mb-4">
                                    <Link href="#" className="hover:underline">Privacy Policy</Link>
                                </li> */}
                                <li>
                                    <Link href="/terminos-condiciones" className="hover:underline">Terminos y condiciones</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center ">© 2024 <Link href="/" className="hover:underline">ENVAPLASTIC</Link>. Todos los derechos reservados.
                    </span>
